    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <div class="w-full font-Alata shadow-2xl rounded-3xl">
        <form
          ...
          class="bg-white shadow-md rounded-3xl  pb-8 mb-4 flex-col flex items-center justify-center"
        >
          ...
          <div className="flex max-md:flex-col items-center  justify-between py-5 ">
            ...
            {/* username input */}
            <input
              class="shadow appearance-none border bg-offgray rounded-lg w-[19vw] max-md:mb-5 md:mr-4 max-md:w-[60vw] py-3 px-3 border-gray-600  text-gray-700 leading-tight focus:outline-double focus:shadow-outline focus:border-Yellow"
              id="username"
              type="text"
            ...
            {/* useremail  input*/}
            <input
              class="shadow appearance-none border border-gray-600 bg-offgray rounded-lg md:w-[19vw] max-md:w-[60vw] py-3 px-3 text-gray-700  leading-tight focus:outline-double  focus:border-Yellow "
              id="email"
              type="email"
              onChange={(e) =>
          ...
          <textarea
            ...
            rows="4"
            class=" py-2 px-2 md:w-[39vw] max-md:w-[60vw] text-sm bg-offgray text-gray-900  rounded-lg border border-gray-600  "
